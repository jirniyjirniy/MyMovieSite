    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fees_in_usa', models.PositiveIntegerField(default=0, help_text='указывать в долларах', verbose_name='Сборы в США')),
                ('fees_in_world', models.PositiveIntegerField(default=0, help_text='указывать в долларах', verbose_name='Сборы в мире')),
                ...
                ('directors', models.ManyToManyField(related_name='film_derector', to='movies.actor', verbose_name='режиссер')),
