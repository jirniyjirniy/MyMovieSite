...
class Movie(models.Model):
    ...
    budget = models.PositiveIntegerField('Бюджет', default=0, help_text='указывать суму в долларах')
    fees_in_usa = models.PositiveIntegerField('Сборы в США', default=0, help_text='указывать в долларах')
...
class MovieShots(models.Model):
    ...
    description = models.TextField('Описание')
    image = models.ImageField('Кадры из фильма', upload_to='movie_shots/')
...
class Reviews(models.Model):
    ...
    parent = models.ForeignKey(
        'self', verbose_name='Родитель', on_delete=models.SET_NULL, null=True
    )
    movie = models.ForeignKey(Movie,verbose_name='фильм', on_delete=models.CASCADE)
